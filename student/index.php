...
<body>
    ...
    <div class="content" style="margin-top: 20px; margin-left: 10px;">
    	...
    	<form action="php/feed.inc.php" method="POST" style="margin-left: 15px; margin-top: 28px;">
		 	<div class="form-group">
		 		<textarea class="form-control" style="width: 740px;" name="message"></textarea>
		 	</div>
		 	<div class="form-group">
		 		<button type="submit" class="btn" name="post" style="color: white;
