...
<body>
    ...
    <div class="content" style="margin-top: 110px; margin-left: 60px; width: 400px;">
        <h3>About Us</h3>
    	<p class="lead"><b>V-Campus Placement System</b> is an application mainly developed for the college to add and maintain companies 
        that are available for campus drive in the college. And to maintain the record of the students who have got selected for companies
