...
<body>
    ...
    <div class="content" style="margin-top: 40px; margin-left: -0px;">
    	<h1 class="form-row justify-content-center" style="margin-left: 140px;">Add Admin</h1> <br>
		      ...
		      <div class="center one">
		        <div class="form-row">
			        ...
			        <div class="form-group col-md-6">
			          ...
			          <input type="text" class="form-control" id="cname" name="username">
			        </div>
		        </div>
		        <div class="form-row">
		        	<div class="form-group col-md-6">
			          <label for="cid">First Name</label>
			          <input type="text" class="form-control" id="cid" name="fname">
			        </div>
			        <div class="form-group col-md-6">
			          <label for="cname">Last Name</label>
			          <input type="text" class="form-control" id="cname" name="lname">
			        </div>
		        </div>
		        <div class="form-row">
		        	<div class="form-group col-md-6">
			          <label for="cid">Mail-ID</label>
			          <input type="text" class="form-control" id="cid" name="mailid">
			        </div>
			        <div class="form-group col-md-6">
		        ...
		        <div class="form-row">
		        	<div class="form-group col-md-6">
			          ...
			          <input type="password" class="form-control" id="cid" name="pwd1">
			        </div>
			        <div class="form-group col-md-6">
			          <label for="cname">Confirm Password</label>
			          <input type="password" class="form-control" id="cname" name="pwd2">
			        </div>
		        </div>
