...
<body>
    ...
    <div class="content" style="margin-top: 160px; margin-left: 10px;">
    	<h1 style="margin-left: 30px; font-size: 64px; color: white;">V-CAMPUS <br><b> PLACEMENT </b><br> SYSTEM</h1> <br>
    ...
    <div id="users" style="z-index: 1; position: relative; margin-top: 130vh;">
        ...
        <div class="card-group">
          <div class="card" style="width: 400px; background: none; "align="center">
            <img src="images/admin1.svg" class="card-img-top" alt="..." style="width: 400px;">
            <div class="card-body">
              <h2 class="card-title" align="center">Admin</h5>
              <p class="card-text"><small class="text-muted">Placement Officer</small></p>
            </div>
          </div>
          <div class="card" style="width: 400px; background: none; " align="center">
            <img src="images/student1.svg" class="card-img-top" alt="..." style="width: 410px; margin-top: 10px;">
            <div class="card-body"> <br>
              <h2 class="card-title" align="center">User</h5>
      ...
      <div id="contact" style="z-index: 1; position: absolute; margin-left:2%; margin-top: 30vh;">
            <div class="form-row">
             <div class="form-group" style="margin-left:270px; margin-top: 200px;"> 
                <h1>Contact Us</h1>
                <p class="lead">&nbsp;<i class="fas fa-mobile"></i>&nbsp; (+91) 22 2416 11 26</p>
                <p class="lead">&nbsp;<i class="fas fa-at"></i>&nbsp; placements@vit.edu.in</p>
              </div>
