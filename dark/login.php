		      ...
		      <div class="center one">
		        ...
		        <div class="form-row">
		        	...
		        	<div class="form-row">
		        		...
		        		<div class="form-group">
		        			<a href="forgot.php" class="btn text-light" style="margin-left: 30px;">Forgot Password?</a>
		        		</div>
						<div class="form-group">
		        			<a href="register.php" class="btn btn-dark btn-sm text-dark"><u>Don't have an account?, Sign Up!</u></a>
		        		</div>
		      </div>
		    </div>
		  </form> 
