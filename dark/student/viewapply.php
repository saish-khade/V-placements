...
<body>
    ...
    <div class="content" style="margin-top: 40px; margin-left: -30px;">
    	...
    	<?php 
    		...
    		$sql = "SELECT * FROM `applied` where name='$user' and status!='Selected' and status!='Rejected' and company in (select name from company);";
          ...
          <ul style="list-style: square;">
            <li class="lead"><a href="viewcompanies.php?id=<?php echo $row['id']; ?>" class="text-light"><?php echo $row['company']; ?></a></li>
          </ul>
          </form>
          <?php
    	}
